# Architecture — codex-as-critic-guardrail (Claude Code host)

Cross-vendor guardrail: **executor host** is Claude Code; the **critic
...
- Unlock: `PostToolUse` matcher `Bash`, command containing `consult_critic`
