...
class HookTests(unittest.TestCase):
    ...
    def test_gate_denies_before_consult_and_allows_after(self):
        ...
        with patch.object(advisor_gate, "has_marker", return_value=True):
            self.assertEqual(self.invoke(advisor_gate, {"session_id": "gate"}), "")
    ...
    def test_hooks_match_only_claude_write_and_cursor_advisor_surfaces(self):
        ...
        self.assertNotIn("consult_critic", post)
