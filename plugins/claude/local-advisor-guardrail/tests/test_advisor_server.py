...
class AdvisorServerTests(unittest.TestCase):
    def test_manifest_uses_local_plugin_identity(self):
    ...
    def test_manifest_selects_server_with_host_argument(self):
        root = SERVER_PATH.parents[1]
        ...
        self.assertIn("${PLUGIN_ROOT}/mcp/advisor_server.py", codex["args"])
