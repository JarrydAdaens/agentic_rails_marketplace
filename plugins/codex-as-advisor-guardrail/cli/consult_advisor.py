...
"""Cursor Shell transport: stdin JSON consult_advisor."""
...
from advisor_consult import consult, is_hard_failure_message  # noqa: E402
...
def main() -> int:
    ...
    try:
        ...
        print(f"consult_advisor stdin must be a JSON object: {exc}", file=sys.stderr)
        return 2
