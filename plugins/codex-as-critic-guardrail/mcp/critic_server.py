...
"""Claude Code stdio MCP server for consult_critic (thin JSON-RPC over lib/)."""
...
from critic_consult import (  # noqa: E402
...
TOOL = {
    "name": "consult_critic",
    "description": (
        "Consult the adversarial, read-only Codex critic for a cross-vendor second "
