...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(description="Retest Claude-as-advisor health for a session.")
    parser.add_argument(
        "--session-id",
    ...
    parser.add_argument(
        ...
        help="Project root containing harness/claude-as-advisor-guardrail/cursor-config.json",
    )
