...
"""Bounded health probe for the Claude advisor backend."""
...
from advisor_config import AdvisorConfig, load_advisor_config, resolve_health_timeout  # noqa: E402
from advisor_consult import run_claude_prompt  # noqa: E402
from advisor_session import (  # noqa: E402
    clear_consulted,
    format_status_block,
    mark_offline,
    mark_online,
...
HEALTH_PROMPT = (
    "Reply with exactly ADVISOR_OK and nothing else. "
    "Do not read or modify files."
)
HEALTH_TOKEN = "ADVISOR_OK"
SKIP_HEALTH_ENV_VAR = "CLAUDE_ADVISOR_SKIP_HEALTH"
...
def _offline(session_id: str, config: AdvisorConfig, reason: str) -> HealthResult:
