...
"""Per-session consult and health markers for the Claude advisor guardrail."""
...
MARKER_DIR_NAME = "claude-as-advisor-guardrail-markers"
HEALTH_SKILL = "claude-advisor-health"
BACKEND_LABEL = "Claude-as-advisor"
