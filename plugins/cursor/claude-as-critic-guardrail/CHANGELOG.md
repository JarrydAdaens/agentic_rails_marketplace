...
- Align generated critic JSONC timeout documentation with the advisor and
  regression-test the actual initializer output.

## 1.3.2 — 2026-08-22

- Add `/claude-critic-timeout` for persisted, validated consult timeout
...
- Add model/effort cancellation and the `/claude-critic-version` skill, which
