...
The consult timeout is the maximum number of seconds Cursor waits for a full Claude critic consult before it is hard-killed.
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        print(f"Could not update critic consult timeout: {exc}", file=sys.stderr)
        return 1
    print(
        f"Critic consult timeout is now: {updated.consult_timeout_seconds} seconds, "
