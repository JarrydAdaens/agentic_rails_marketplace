---
name: claude-critic-model
description: >-
  Select and persist the Claude critic model and reasoning effort for this
  project. Use when the user wants a different critic model or effort level.
...
```text
uv run --no-project python ./scripts/launch.py ./cli/critic_model.py --model "<USER_SELECTION>" --workspace <PROJECT_ROOT>
```
