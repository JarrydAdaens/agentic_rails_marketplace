...
"""Write the default harness config for codex-as-critic-guardrail."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    parser = argparse.ArgumentParser(
        description="Write harness/codex-as-critic-guardrail/cursor-config.json with defaults and comments."
    )
    parser.add_argument(
        "--workspace",
    ...
    print("Codex-as-critic config initialized")
    print(f"Path: {path}")
