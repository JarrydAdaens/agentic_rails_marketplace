"""Parse Codex model/effort choices and persist critic defaults."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        return 1
    print(f"Critic is now model: {updated.model.upper()}, effort: {EFFORT_NAMES.get(updated.effort, updated.effort.title())}, and is saved as your default for new sessions in this project.")
    return 0
