"""Persist the critic consult timeout using natural number input."""
...
from critic_config import DEFAULT_CONSULT_TIMEOUT_SECONDS, config_path, load_critic_config, update_critic_config  # noqa: E402
