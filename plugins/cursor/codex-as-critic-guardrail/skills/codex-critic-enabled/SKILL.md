---
name: codex-critic-enabled
description: Enable or disable the Codex critic guardrail for this project and persist the choice in JSONC.
argument-hint: "<enabled|disabled>"
disable-model-invocation: true
---
# Codex critic enabled
